				...
				<div class="size-210 bor10 p-lr-70 p-t-55 p-b-70 p-lr-15-lg w-full-md">
					<form id="frmContacto">
                        ...
                        <div class="bor8 m-b-20 how-pos4-parent">
						    ...
						    <img class="how-pos4 pointer-none" src="<?= media() ?>/tienda/images/icons/icon-name.png" alt="ICON MaddsGT" style="width: 28px;">
					    </div>
						...
						<div class="bor8 m-b-20 how-pos4-parent">
							...
							<img class="how-pos4 pointer-none" src="<?= media() ?>/tienda/images/icons/icon-email.png" alt="ICON MaddsGT">
						</div>

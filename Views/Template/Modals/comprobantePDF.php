...
<body>
	<table class="tbl-hader">
		<tbody>
			<tr>
				<td class="wd33">
					<img src="<?= media() ?>/tienda/images/logo.png" alt="Logo MaddsGT">
				</td>
				<td class="text-center wd34">
					<h4><strong><?= NOMBRE_EMPESA ?></strong></h4>
					<p><?= DIRECCION ?> <br>
					Teléfono: <?= TELEMPRESA ?> <br>
					Email: <?= EMAIL_EMPRESA  ?></p>
				</td>
				<td class="text-right wd34">
	...
	<div class="text-center">
		<p>Si tienes preguntas sobre tu pedido, <br> no dudes en ponerte en contacto con nostros con tu nombre, teléfono y Email</p>

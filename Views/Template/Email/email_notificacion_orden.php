...
//variable para acceder al array pedido y despues a orden
...
<body>
	<div>
			...
			<tr>
				...
				<td width="33.33%">
					<div class="text-center">
						<h4><strong><?= NOMBRE_EMPESA ?></strong></h4><br>
						<p>
							<?= DIRECCION ?> <br>
		...
		<div class="text-center">
			<p>Si tienes preguntas sobre tu pedido, <br>pongase en contacto con nosotros en redes soliciales, incluyendo: nombre, teléfono y Email</p>
